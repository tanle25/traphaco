                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <div class="form-group">
                                ...
                                <input name="" type="text" class="form-control" id="" readonly
                                    placeholder="Nhập password (Bắt buộc)" value="<?php echo e($survey->author->fullname); ?>">
                                <input type="hidden" name="created_by" value="<?php echo e($survey->author->id); ?>">
                            </div>
...
<?php echo $__env->make('admin.main_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\DEV\Employees management\HR manager\resources\views/admin/pages/survey/edit.blade.php ENDPATH**/ ?>