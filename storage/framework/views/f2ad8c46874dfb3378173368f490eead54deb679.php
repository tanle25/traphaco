...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="card">
            <div class="card-header">
              <h3 class="card-title">Chọn người được chấm</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <?php echo $__env->make('admin.pages.tests.tables.candiate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
            <!-- /.card-body -->
        </div>
    </section>
...
<?php echo $__env->make('admin.main_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\DEV\Employees management\HR manager\resources\views/admin/pages/tests/create.blade.php ENDPATH**/ ?>