...
<body class="bottom-login">
  <div id="page-login" class="w-full justify-center items-center flex h-screen bg-img" style="background-image: url({{asset('template/images/vuexy-login-bg.jpg')}});background-position: 50%;background-repeat: no-repeat;background-size: cover;">
