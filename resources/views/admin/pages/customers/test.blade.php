    ...
    <div class="card-body">
        <form action="{{route('admin.customer.edit_field', $customer->id)}}" method="post" id="customer-test-form">
            ...
            <div class="form-inline">
                ...
                <input type="test" id="test-fullname-value" class="col-md-9 col-11 form-control  no-border" name="fullname" value="{{$customer->fullname}}" placeholder="Nhập tên khách hàng">
                <label for="test-fullname-value" class="col-1">...</label>
            </div>
            <div class="form-inline">
                <label class="col-md-2 d-inline-block text-left">Tên nhà thuốc:</label>
                <input type="test" id="test-fullname-value" class="col-md-9 col-11 form-control  no-border" name="pharmacy_name" value="{{$customer->pharmacy_name}}" placeholder="Nhập tên hiệu thuốc">
                <label for="test-fullname-value" class="col-1">...</label>
            </div>
            <div class="form-inline">
                <label class="col-md-2 col-12 d-inline-block text-left">Địa chỉ:</label>
                <input type="test" id="test-address-value" class="col-md-9 col-11 form-control  no-border" value="{{$customer->address}}" name="address" placeholder="Nhập địa chỉ khách hàng">
                <label for="test-address-value" class="col-1">...</label>
            </div>
            <div class="form-inline">
                <label class="col-md-2 d-inline-block text-left">Số điện thoại:</label>
                <input type="test" id="test-phone-value" class="col-md-9 col-11 form-control no-border" value="{{$customer->phone}}" name="phone" placeholder="Nhập số điện thoại">
                <label for="test-phone-value" class="col-1">...</label>
            </div>
            <div class="form-inline">
                <label class="col-md-2 d-inline-block text-left">Địa bàn:</label>
                <input id="test-zone-value" type="test" class="col-md-9 col-11 form-control no-border" value="{{$customer->zone}}" name="zone" placeholder="Nhập tên địa bàn">
