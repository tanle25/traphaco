...
(function ($) {
    ...
    var w = window,
        ...
        supportsTransitions = (function () {
            ...
            for (i = v.length; i--; ) if (s[v[i] + prop] == "") return true;
            return false;
        })(),
    ...
    Sticky.prototype = {
        ...
        rePosition: function (quick, force) {
            var $obj = this.obj,
                ...
                areaScrollTop =
                    this.settings.scrollArea == w
                        ? w.scrollY
                            ? w.scrollY
                            : doc.documentElement.scrollTop
                        : this.settings.scrollArea.scrollTop,
                areaHeight =
                    this.settings.scrollArea == w
                        ? doc.documentElement.offsetHeight
                        : this.settings.scrollArea.offsetHeight;

            this.areaViewportHeight =
                this.settings.scrollArea == w
                    ? doc.documentElement.clientHeight
                    : this.settings.scrollArea.clientHeight;
            ...
            if (settings.lockBottom)
                maxTopPos =
                    $obj[0].parentNode.clientHeight -
                    this.stickyHeight -
                    settings.offsetBottom; // get the maximum top position of the floated element inside it's parent
            ...
            objFartherThanTopPos =
                $obj.offset().top > settings.startOffset + settings.offsetY; // check if the object is at it's top position (starting point)
            ...
            if (
                ...
                // if window scrolled < starting offset, then reset Obj position (settings.offsetY);
                    ...
                    areaScrollTop < settings.startOffset &&
                ...
                if (
                    duration < 5 ||
                    (settings.cssTransition && supportsTransitions)
                )
    ...
    $.fn.stickyfloat = function (option, settings) {
        ...
        return this.each(function () {
            ...
            if (typeof option === "object") settings = option;
                ...
                if (
                    $obj.data("_stickyfloat") &&
                    typeof $obj.data("_stickyfloat")[option] == "function"
                ) {
